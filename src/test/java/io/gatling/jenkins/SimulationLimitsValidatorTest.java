...
public class SimulationLimitsValidatorTest {
    ...
    public void testValidScenario() {
        ...
        RequestReport requestReport = createRequestReport(new Statistics(), meanNumberOfRequestsPerSecond,
                meanResponseTime, numberOfRequests);
        ...
        SimulationLimitsValidator validator = new SimulationLimitsValidator(Arrays.asList(buildSimulation),
                Arrays.asList(simulationLimits), System.out);
    ...
    private RequestReport createRequestReport(Statistics maxRespTime, Statistics meanNumberOfReqPerSec,
            Statistics meanRespTime, Statistics numberOfReq) {
